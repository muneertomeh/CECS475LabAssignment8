...
function Post(el) {
    ...
    var $el = $(el),
        ...
        professorKey = commentsContainer.data('professor-key'),
    ...
    // RESTful Web API URL:  /api/posts/{professorKey}/comments
    var webApiUrl = ['/api/posts', professorKey, 'comments'].join('/');
